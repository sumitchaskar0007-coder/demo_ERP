...
export function StudentProfilePage() {
  ...
  return (
    <div className="page-container space-y-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between"><div><h1 className="page-title">My Profile</h1><p className="page-subtitle">Your student account and college details.</p></div><Link to={ROUTES.changePassword}><Button variant="secondary"><KeyRound className="h-4 w-4" />Change Password</Button></Link></div>
