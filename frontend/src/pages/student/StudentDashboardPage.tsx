  ...
  return (
    <div className="page-container pb-10">
      ...
      <div className="mt-6 grid gap-6 xl:grid-cols-[1.35fr_0.8fr]">
        ...
        <Card className="overflow-hidden"><div className="border-b px-6 py-5"><h2 className="font-bold">Quick access</h2><p className="mt-1 text-xs text-slate-500">Open your available ERP services</p></div><div className="space-y-2 p-4"><QuickCard to={ROUTES.studentAdmission} icon={<FileText />} label="My Admission" /><QuickCard to={ROUTES.studentProfile} icon={<UserRound />} label="My Profile" /><QuickCard to={ROUTES.studentFees} icon={<WalletCards />} label="My Fees" /><QuickCard to={ROUTES.studentAttendance} icon={<CalendarDays />} label="My Attendance" /></div></Card>
      </div>
    </div>
  );
}
