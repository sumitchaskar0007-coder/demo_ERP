...
import { createFeeSectionStaff } from "@/features/staff/api";
    ...
    <div className="page-container">
      <Card className="mx-auto max-w-2xl p-7">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          ...
          />
          <Input label="Full Name" onChange={(e) => setV({ ...v, fullName: e.target.value })} />
          <Input
            label="Email"
            type="email"
