...
export function DepartmentListPage() {
  ...
  const toggle = async () => {
    ...
    try {
      const response = await api.setDepartmentStatus(confirming.id, confirming.status !== "ACTIVE");
      toast.success(response.message);
      setConfirming(null);
      await load();
    } catch (error) {
  ...
  return (
    <div className="page-container">
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            {admin
              ? "Manage departments across colleges."
      ...
      <Card className="mt-6 overflow-hidden">
        ...
        {loading ? (
          ...
          <EmptyState
            ...
            description="Adjust your filters or create a department."
          />
        )}
      </Card>
      <Modal
        ...
        description={
          editing
            ? "Department code and college cannot be changed."
            : "Create a department inside an active college."
        }
      >
        <DepartmentForm
          department={editing}
      ...
      <ConfirmDialog
        ...
        title={`${confirming?.status === "ACTIVE" ? "Deactivate" : "Activate"} department?`}
        description="The department record will remain available and only its status will change."
