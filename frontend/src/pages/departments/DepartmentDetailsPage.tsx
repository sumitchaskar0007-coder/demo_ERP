    ...
    <div className="page-container">
      ...
      <Card className="mt-4 overflow-hidden">
        <div className="bg-gradient-to-r from-indigo-700 to-blue-700 p-8 text-white">
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <Badge tone="info">{item.code}</Badge>
            </div>
          </div>
        </div>
        <div className="grid gap-5 p-6 md:grid-cols-2">
          <div className="rounded-2xl bg-slate-50 p-5">
            <Building2 className="mb-3 h-5 w-5 text-brand-600" />
            <p className="text-xs font-bold uppercase text-slate-400">College</p>
        ...
        <div className="grid gap-4 border-t p-6 text-sm sm:grid-cols-2">
          <p>
            <span className="text-slate-400">Created:</span> {formatDate(item.createdAt)}
          </p>
          <p>
            <span className="text-slate-400">Updated:</span> {formatDate(item.updatedAt)}
          </p>
        </div>
      </Card>
    </div>
