      ...
      <div className="ml-auto flex items-center gap-2 sm:gap-3">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-3 rounded-xl border bg-white p-1.5 pr-3 hover:bg-slate-50"
          >
            {profileImage ? (
              <img
                src={profileImage}
              ...
              <div className="grid h-10 w-10 place-items-center rounded-lg bg-brand-100 text-sm font-bold text-brand-700">
