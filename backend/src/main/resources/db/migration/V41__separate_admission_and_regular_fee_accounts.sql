ALTER TABLE student_fee_accounts
    DROP CONSTRAINT IF EXISTS uk_fee_account_admission;

CREATE UNIQUE INDEX IF NOT EXISTS uk_fee_account_admission_kind
    ON student_fee_accounts (admission_form_id, (fee_structure_id IS NULL));
