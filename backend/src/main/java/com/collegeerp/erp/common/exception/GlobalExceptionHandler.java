...
import com.collegeerp.erp.common.error.ClientErrorMessage;
import com.collegeerp.erp.common.error.RequestCorrelation;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(com.collegeerp.erp.admission.exception.AdmissionInformationValidationException.class)
    public ResponseEntity<ErrorResponse> handleAdmissionInformationValidation(
            com.collegeerp.erp.admission.exception.AdmissionInformationValidationException exception) {
    ...
    @ExceptionHandler(com.collegeerp.erp.auth.security.AuthorizationStateUnavailableException.class)
    public ResponseEntity<ErrorResponse> handleAuthorizationStateUnavailable(
            com.collegeerp.erp.auth.security.AuthorizationStateUnavailableException exception,
    ...
    @ExceptionHandler(com.collegeerp.erp.admission.service.UploadScanPendingException.class)
    public ResponseEntity<ErrorResponse> handleUploadScanPending(
            com.collegeerp.erp.admission.service.UploadScanPendingException exception,
            HttpServletRequest request) {
