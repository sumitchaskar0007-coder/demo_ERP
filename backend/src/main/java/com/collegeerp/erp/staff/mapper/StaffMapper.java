package com.collegeerp.erp.staff.mapper;
        ...
        return new StaffResponse(
                ...
                profile.getUser().getRoles().stream()
                        .map(role -> switch (role.getName()) {
                            case PRINCIPAL -> com.collegeerp.erp.staff.enums.StaffType.TEACHER;
                            case HOD -> com.collegeerp.erp.staff.enums.StaffType.HOD;
                            case CLASS_TEACHER -> com.collegeerp.erp.staff.enums.StaffType.CLASS_TEACHER;
                            case SUBJECT_TEACHER -> com.collegeerp.erp.staff.enums.StaffType.SUBJECT_TEACHER;
                            case STUDENT_SECTION -> com.collegeerp.erp.staff.enums.StaffType.STUDENT_SECTION;
                            case FEE_SECTION -> com.collegeerp.erp.staff.enums.StaffType.FEE_SECTION;
                            default -> com.collegeerp.erp.staff.enums.StaffType.GENERAL_STAFF;
                        })
