...
import com.collegeerp.erp.notice.dto.NoticeDeliveryMode;
...
public class Notice extends BaseAuditEntity {
    ...
    private Set<com.collegeerp.erp.college.entity.College> colleges = new HashSet<>();
    ...
    public Set<com.collegeerp.erp.college.entity.College> getColleges() { return colleges; }
    public void setColleges(Set<com.collegeerp.erp.college.entity.College> colleges) { this.colleges = colleges; }
