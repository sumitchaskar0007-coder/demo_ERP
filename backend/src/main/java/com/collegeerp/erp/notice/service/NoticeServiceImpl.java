...
import com.collegeerp.erp.notice.entity.NoticeAcknowledgement;
...
public class NoticeServiceImpl implements NoticeService {
    ...
    public PageResponse<NoticeRecipientOption> searchRecipients(
        ...
        Map<Long, com.collegeerp.erp.student.entity.StudentProfile> studentByUser =
    ...
    private void ensureRecipientWithinScope(User recipient, CustomUserDetails current) {
        if (recipient.getStatus() != com.collegeerp.erp.user.entity.UserStatus.ACTIVE)
