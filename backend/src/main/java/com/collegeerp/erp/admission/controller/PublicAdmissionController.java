...
import com.collegeerp.erp.fee.dto.FeeCategoryOptionResponse;
...
public class PublicAdmissionController {
    ...
    public ApiResponse<java.util.List<FeeCategoryOptionResponse>> categories(
        ...
        String normalizedGender = gender == null || gender.isBlank() ? null
                : com.collegeerp.erp.fee.service.FeeCategoryRules.normalizeGender(gender);
        java.util.List<String> academicYears = academicYear == null || academicYear.isBlank() ? null
                : com.collegeerp.erp.fee.service.FeeCategoryRules.academicYearVariants(academicYear);
        ...
        configured.forEach(f -> {
            ...
            if (custom == null
                    || com.collegeerp.erp.fee.service.FeeCategoryRules.isReservedCustomCategory(custom)) {
                return;
            }
