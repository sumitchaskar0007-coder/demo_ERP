...
import com.collegeerp.erp.admission.dto.AdmissionDepartmentOptionResponse;
...
import com.collegeerp.erp.admission.entity.AdmissionAcademicRecord;
...
import com.collegeerp.erp.admission.enums.AdmissionSource;
...
import com.collegeerp.erp.admission.mapper.AdmissionPrintMapper;
...
import com.collegeerp.erp.auth.password.InitialPasswordPolicy;
...
import com.collegeerp.erp.fee.service.FeeCategoryRules;
...
import com.collegeerp.erp.admission.dto.AdmissionDetailDraftRequest;
import com.collegeerp.erp.admission.dto.AdmissionDetailDraftResponse;
...
public class AdmissionServiceImpl implements AdmissionService {
    ...
    @Override
    @Transactional(readOnly = true)
    public com.collegeerp.erp.admission.dto.AdmissionInformationValidationResponse
        ...
        informationValidation.validate(admission, request);
        return new com.collegeerp.erp.admission.dto.AdmissionInformationValidationResponse(true);
    }
    ...
    private java.util.ArrayList<com.collegeerp.erp.admission.entity.AdmissionEntranceExam> entranceExams(
            DetailedAdmissionRequest request) {
        if (request.entranceExams() != null) {
            return request.entranceExams().stream()
                    .map(exam -> new com.collegeerp.erp.admission.entity.AdmissionEntranceExam(
        ...
        return new java.util.ArrayList<>(java.util.List.of(
                new com.collegeerp.erp.admission.entity.AdmissionEntranceExam(name, result)));
    }
    ...
    private AdmissionAcademicRecord academicRecord(com.collegeerp.erp.admission.dto.AcademicRecordDto record) {
    ...
    private void validateAcademicResult(com.collegeerp.erp.admission.dto.AcademicRecordDto record) {
        if ((record.gradingType() == com.collegeerp.erp.admission.enums.AcademicGradingType.PERCENTAGE
                && record.cgpa() != null)
                || (record.gradingType() == com.collegeerp.erp.admission.enums.AcademicGradingType.CGPA
    ...
    private void validateMarks(com.collegeerp.erp.admission.dto.AcademicRecordDto record) {
    ...
    private String normalizeCustomCategory(com.collegeerp.erp.fee.enums.StudentCategory category, String value) {
    ...
    private String validateConfiguredCategory(
            ...
            String academicYear,
            String gender,
            com.collegeerp.erp.fee.enums.StudentCategory category,
