...
public class AdmissionInformationValidationService {
    ...
    private String validateCategoryName(
        ...
        try {
            ...
            errors.put(request.studentCategory() == com.collegeerp.erp.fee.enums.StudentCategory.OTHER
    ...
    private void validateAcademicRecord(
        ...
        if (record.gradingType() == com.collegeerp.erp.admission.enums.AcademicGradingType.CGPA
