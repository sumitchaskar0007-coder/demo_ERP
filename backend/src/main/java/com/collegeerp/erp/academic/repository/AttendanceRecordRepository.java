...
import com.collegeerp.erp.academic.entity.AttendanceRecord;
...
public interface AttendanceRecordRepository extends JpaRepository<AttendanceRecord, Long> {
    ...
    @Query("""
            select s.fullName as studentName,
                   ...
                   coalesce(sum(case when r.status = com.collegeerp.erp.academic.enums.AttendanceStatus.PRESENT then 1 else 0 end), 0) as presentCount
