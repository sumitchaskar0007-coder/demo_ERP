...
import com.collegeerp.erp.email.enums.EmailPriority;
...
public class EmailNotificationServiceImpl implements EmailNotificationService {
    ...
    @Override
    @Transactional
    public void queueAdmissionCompletedEmail(
            User user, String admissionReferenceNumber) {
        queue(
                user,
    ...
    public void queueAccountActivatedEmail(User user) {
        queue(
                ...
                "Account activated",
                "account-activated",
                Map.of("name", user.getFullName(), "url", frontendUrl + "/login"),
                "ACTIVATED");
    }
    ...
    @Override
    @Transactional
    public void queuePasswordResetEmail(
    ...
    @Override
    @Transactional
    public void queueEmailVerificationEmail(
            User user, String token, LocalDateTime expiresAt) {
        queue(
                user,
    ...
    public void queueFeePaymentReminder(
        ...
        queue(
                user,
                EmailType.FEE_PAYMENT_REMINDER,
                "Pending fee payment reminder",
        ...
        try {
            ...
            if (saved.getId() == null) {
                throw new IllegalStateException(
                        "Email notification was persisted without an ID");
            }
            queueDispatcher.publishAfterCommit(saved.getId());
        } catch (Exception exception) {
            throw new IllegalStateException(
                    "Could not queue email notification", exception);
        }
    }
