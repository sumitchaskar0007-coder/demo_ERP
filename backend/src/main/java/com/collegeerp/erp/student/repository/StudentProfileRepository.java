...
public interface StudentProfileRepository extends JpaRepository<StudentProfile, Long>,
    ...
    @Query("""
            select new com.collegeerp.erp.fee.dto.CollegeCountPoint(s.college.name, count(s.id))
            from StudentProfile s
            where s.status = com.collegeerp.erp.student.enums.StudentStatus.ACTIVE
