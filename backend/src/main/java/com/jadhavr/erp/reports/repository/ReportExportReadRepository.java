package com.jadhavr.erp.reports.repository;

import com.jadhavr.erp.admission.enums.AdmissionStatus;
import com.jadhavr.erp.reports.dto.AdmissionCsvRow;
import com.jadhavr.erp.reports.dto.FeeCsvRow;
import com.jadhavr.erp.reports.dto.StudentCsvRow;
...
public class ReportExportReadRepository {
    ...
    public List<AdmissionCsvRow> admissions(
            ...
            int limit) {
        String jpql = """
                select new com.jadhavr.erp.reports.dto.AdmissionCsvRow(
                    admission.id,
    ...
    public List<FeeCsvRow> fees(
        ...
        String jpql = """
                select new com.jadhavr.erp.reports.dto.FeeCsvRow(
                    account.id,
    ...
    public List<StudentCsvRow> students(
            ...
            int limit) {
        String jpql = """
                select new com.jadhavr.erp.reports.dto.StudentCsvRow(
                    student.id,
                    student.fullName,
                    student.rollNumber,
                    student.email,
