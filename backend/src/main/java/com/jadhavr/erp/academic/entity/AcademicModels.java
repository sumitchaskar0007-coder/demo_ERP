...
public final class AcademicModels {
    ...
    @Entity @Table(name="academic_years", uniqueConstraints=@UniqueConstraint(columnNames={"college_id","name"}))
    ...
    @Entity @Table(name="academic_terms", uniqueConstraints=@UniqueConstraint(columnNames={"college_id","academic_year_id","name"}))
    ...
    @Entity @Table(name="academic_programs", uniqueConstraints=@UniqueConstraint(columnNames={"college_id","code"}))
    ...
    @Entity @Table(name="academic_semesters", uniqueConstraints=@UniqueConstraint(columnNames={"college_id","program_id","number"}))
    ...
    @Entity @Table(name="academic_classes", uniqueConstraints=@UniqueConstraint(columnNames={"college_id","program_id","semester_id","name"}))
    ...
    @Entity @Table(name="academic_sections", uniqueConstraints=@UniqueConstraint(columnNames={"college_id","class_id","name"}))
    ...
    @Entity @Table(name="academic_subjects", uniqueConstraints=@UniqueConstraint(columnNames={"college_id","code"}))
    ...
    @Entity @Table(name="academic_rooms", uniqueConstraints=@UniqueConstraint(columnNames={"college_id","code"}))
    ...
    @Entity @Table(name="academic_periods", uniqueConstraints=@UniqueConstraint(columnNames={"college_id","period_number"}))
    ...
    @Entity @Table(name="academic_working_days", uniqueConstraints=@UniqueConstraint(columnNames={"college_id","day_of_week"}))
    ...
    @Entity @Table(name="academic_holidays", uniqueConstraints=@UniqueConstraint(columnNames={"college_id","holiday_date"}))
    ...
    @Entity @Table(name="teacher_subject_assignments", uniqueConstraints=@UniqueConstraint(columnNames={"college_id","teacher_id","subject_id","class_id","section_id"}))
    ...
    @Entity @Table(name="class_teacher_assignments", uniqueConstraints=@UniqueConstraint(columnNames={"college_id","academic_year_id","class_id","section_id"}))
    ...
    @Entity @Table(name="student_enrollments", uniqueConstraints=@UniqueConstraint(columnNames={"college_id","academic_year_id","student_id"}))
