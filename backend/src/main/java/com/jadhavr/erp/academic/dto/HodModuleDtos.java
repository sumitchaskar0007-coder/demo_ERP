...
public final class HodModuleDtos {
    ...
    public record StudentRow(Long id,String photoUrl,String name,String prn,String admissionNumber,String gender,String admissionStatus,Long enrollmentId,Long courseYearId,String courseYear,Long divisionId,String division,String rollNumber,String allocationStatus) {}
