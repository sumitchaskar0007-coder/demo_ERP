...
public interface StudentFeeAccountRepository extends JpaRepository<StudentFeeAccount, Long>,
    ...
    @Query(value = """
            select new com.jadhavr.erp.fee.dto.PendingFeeRow(
                ...
                a.remainingAmount)
            from StudentFeeAccount a
            left join StudentSectionEnrollment e on e.student = a.student and e.status = com.jadhavr.erp.academic.enums.AcademicStatus.ACTIVE and e.academicYear = a.academicYear
