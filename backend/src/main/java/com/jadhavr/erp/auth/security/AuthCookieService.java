...
public class AuthCookieService {
    ...
    public void setTokens(HttpServletResponse response, String access, String refresh) {
        ...
        // Keep refresh credentials limited to authentication endpoints while allowing
        // both rotation and current-device logout to revoke the server-side token.
    ...
    public void clear(HttpServletResponse response) {
        ...
        // Spring Security creates this readable cookie for CSRF-protected writes.
        expire(response, "XSRF-TOKEN", "/", false);
    }
    ...
    private void expire(HttpServletResponse response, String name, String path, boolean httpOnly) {
