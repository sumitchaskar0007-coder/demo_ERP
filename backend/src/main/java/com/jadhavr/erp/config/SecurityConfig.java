    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/academic/class-teacher/**").hasRole("CLASS_TEACHER")
                        .requestMatchers("/api/academic/classes/**").hasAnyRole("SUPER_ADMIN", "PRINCIPAL", "HOD")
                        .requestMatchers("/api/academic/sections/**").hasAnyRole("SUPER_ADMIN", "PRINCIPAL", "HOD", "CLASS_TEACHER")
                        .requestMatchers("/api/academic/subjects/**").hasAnyRole("SUPER_ADMIN", "PRINCIPAL", "HOD", "SUBJECT_TEACHER")
                        .requestMatchers("/api/academic/timetable/**").hasAnyRole("SUPER_ADMIN", "PRINCIPAL", "HOD", "CLASS_TEACHER", "SUBJECT_TEACHER")
                        .requestMatchers("/api/academic/attendance/**").hasAnyRole("SUPER_ADMIN", "PRINCIPAL", "HOD", "CLASS_TEACHER", "SUBJECT_TEACHER")
