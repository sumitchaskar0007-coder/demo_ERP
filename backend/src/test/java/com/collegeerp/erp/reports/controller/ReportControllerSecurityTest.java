...
import com.collegeerp.erp.reports.service.AdmissionAnalyticsService;
...
class ReportControllerSecurityTest {
    ...
    void hodCannotRequestAnotherDepartment() {
        ...
        when(hod.getDepartment()).thenReturn(org.mockito.Mockito.mock(com.collegeerp.erp.department.entity.Department.class));
