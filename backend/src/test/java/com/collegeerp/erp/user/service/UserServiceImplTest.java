...
import com.collegeerp.erp.auth.password.LocalPhoneInitialPasswordPolicy;
import com.collegeerp.erp.auth.security.AuthorizationSnapshotService;
import com.collegeerp.erp.auth.security.AuthorizationStateUnavailableException;
...
class UserServiceImplTest {
    ...
    @Test void createPrincipalSuccessAndEncodesPassword() {
        ...
        verify(staffProfiles).save(argThat(profile ->
                profile.getStaffType() == com.collegeerp.erp.staff.enums.StaffType.TEACHER
