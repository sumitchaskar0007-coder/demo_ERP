...
College ERP is a secure, modular college management platform.
...
See the [environment architecture](docs/environments.md) for the strict local,
preproduction, and production configuration and promotion contracts.
